...
func (a *App) initializeRoutes() {
	...
	a.Router.HandleFunc("/players/{name}/{tag}/upcomingchests", a.GetChestsByPlayer).Methods("GET")

	a.Router.HandleFunc("/players/{name}/{tag}/update", a.UpdatePlayer).Methods("GET")
	a.Router.HandleFunc("/", a.Home).Methods("GET")

	a.Router.HandleFunc("/compare/{entry:[0-9A-Z#]+}", a.ComparePlayer).Methods("GET")
